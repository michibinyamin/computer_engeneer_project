...
describe('ResetPassword screen', () => {
  ...
  it('renders all input fields and buttons', () => {
    const { getByPlaceholderText, getByText } = render(<ResetPassword navigation={mockNavigation} />);
  ...
  it('allows user to type an email', () => {
    const { getByPlaceholderText } = render(<ResetPassword navigation={mockNavigation} />);

    fireEvent.changeText(getByPlaceholderText('Enter your email'), 'omar@example.com');
  });
  ...
  it('submits reset password request without crashing', async () => {
    ...
    expect(global.alert).toHaveBeenCalledWith('Reset link sent! Check your inbox.');
